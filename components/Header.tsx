...
//                                             </li>
//                                             <li>
//                                                 <NavLink to="/demo" style={({ isActive }) => isActive ? activeStyle : inactiveStyle}>Demo</NavLink>
//                                             </li>
//                                             {/* <li>
//                                                 <NavLink to="/login" style={({ isActive }) => isActive ? activeStyle : inactiveStyle}>Login</NavLink>
//                                             </li> */}
//                                         </ul>
//                                     </div>
//                                 </div>
